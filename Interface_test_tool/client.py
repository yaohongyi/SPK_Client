...
class Client(QWidget):
    def __init__(self, *args, **kwargs):
        ...
        self.request_grid.addWidget(self.ip_label, 1, 0, 1, 1)
        self.ip_label.setAlignment(QtCore.Qt.AlignCenter | QtCore.Qt.AlignRight)
        self.request_grid.addWidget(self.ip_input, 1, 1, 1, 1)
        self.request_grid.addWidget(self.port_label, 1, 2, 1, 1)
        self.port_label.setAlignment(QtCore.Qt.AlignCenter | QtCore.Qt.AlignRight)
        self.request_grid.addWidget(self.port_input, 1, 3, 1, 1)
        self.request_grid.addWidget(self.path_label, 2, 0, 1, 1)
        self.path_label.setAlignment(QtCore.Qt.AlignCenter | QtCore.Qt.AlignRight)
        self.request_grid.addWidget(self.path_combo_box, 2, 1, 1, 1)
        self.request_grid.addWidget(self.path_input, 2, 2, 1, 2)
        self.request_grid.addWidget(self.request_time_label, 3, 0, 1, 1)
        self.request_grid.addWidget(self.request_time_spin_box, 3, 1, 1, 1)
        self.request_grid.addWidget(self.request_interval_label, 3, 2, 1, 1)
        self.request_grid.addWidget(self.request_interval_spin_box, 3, 3, 1, 1)
        self.request_grid.addWidget(self.parameter_label, 4, 0, 1, 1)
        self.request_grid.addWidget(self.parameter_text_edit, 4, 1, 1, 3)
        # 按钮分组框
